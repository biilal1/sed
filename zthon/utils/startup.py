    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph/file/824b6c606c1b019a219a2.jpg",
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_file("@BotFather", "zthon/BILAL/logozed.jpg")
            ...
            await bot.send_message("@BotFather", f"- بـوت سيدثون المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
...
zthon = {"@E9N99", "@leeleel", "@clccca", "@a_aaaf", "@Tipthon_Help"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            ...
            "كـروب السجـل سيدثون", zedub, Config.TG_BOT_USERNAME, descript, photozed
