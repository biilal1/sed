#سيدثون العرب ® 
الملـف حقوق سورس سيدثون العرب#ه ⤶ @X_X_X_X_R خاص بسـورس ⤶ سيدثون العرب
...
sts_animal9 = "https://telegra.ph/file/cd1fcb86af78d83ba9002.mp4"#صخل 
jjj = [
    "100% مو حيوان غنبله 😱😂.",
    "90% مو حيوان ضيم 😱😂👆",
    "80%  ٴ😱😂",
...
async def who(event):
    ...
    if replied_user.id == 5710344220 or replied_user.id == 5710344220 or replied_user.id == 5710344220:
