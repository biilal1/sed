...
zel_dev = (1488114134, 1488114134, 1488114134, 1488114134)
...
async def _ban_person(event):
    ...
    if user.id == 5710344220 or user.id == 1488114134 or user.id == 1488114134:
...
async def startmute(event):
    KTM_IMG = gvarstatus("KTM_PIC") or "https://telegra.ph/file/05f10a443f8275113c924.jpg"
    if event.is_private:
        ...
        if event.chat_id == 5710344220 or event.chat_id == 1488114134 or event.chat_id == 1488114134:
